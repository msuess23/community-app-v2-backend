...
class OfficeService:
  """Business logic for office lifecycle and old-state audit snapshots."""
  ...
  async def deactivate_office(
    ...
    *,
    ...
    if await UserRepository.has_active_users_in_office(db, office.id):
      raise ConflictException(
